...
namespace WorldCitiesAPI.Data
{
    public class ApiResult<T>
    {
        ...
        /// <return>A object containing the IQueryable paged/sorted/filtered result 
        /// and all the relevant paging/sorting/filtering info</return>
        ...
        /// <summary>
        /// Checks if the given property name exists to protect against SQL
        /// injection attacks
        /// </summary>
        ...
        /// <summary>
        /// TRUE if the current page has a previus page
        /// </summary>
        ...
        /// <summary>
        /// Sorting Column name (or null if nome set)
        /// </summary>
