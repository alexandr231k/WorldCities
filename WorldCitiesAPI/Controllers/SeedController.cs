...
namespace WorldCitiesAPI.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // prevents non-development evironments from running this method
            ...
            // into the Database (it will be empty of first run).
            ...
            for(int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // create the City and fill it with xlsx data
                var city = new City
                {
                    Name = name,
                    Lat = lat,
        ...
        public async Task<ActionResult> CreateDefaultUsers()
        {
            ...
            if(await _userManager.FindByEmailAsync(email_Admin)
                == null)
            {
                ...
                // confirm the e-mail amd remove lockout
            ...
            // check if the standart user already exists
            var email_User = "user@email.com";
            if(await _userManager.FindByEmailAsync(email_User) == null)
            {
                // create a new standart ApplicationUser account
                ...
                // insert the standart user into the DB
                ...
                // add the standart user to the added users list
