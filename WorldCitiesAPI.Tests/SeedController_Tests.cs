...
namespace WorldCitiesAPI.Tests
{
    public class SeedController_Tests
    {
        ...
        {
            /// Arrange
            /// create the option required by the 
            ...
            // create a ICofiguration mock instance
            ...
            // create ApplicationDbContext instance using the in-memory DB
            using var context = new ApplicationDbContext(options);

            // create a RaloManager
            ...
            user_User = await userManager.FindByNameAsync(
                "user@email.com");
